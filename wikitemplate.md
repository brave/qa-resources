...
- [ ] Visit https://www.httpwatch.com/httpgallery/authentication/#showExample10 and ensure basic HTTPWeb Authenticaion is working correctly when clicked on `Display Image` button. Follow the steps mentioned on page to verify it works correctly 
