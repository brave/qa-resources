...
wiki_file = open('wikitemplate-cr-upgrade', 'r')
...
print(bigline)
print("")
mactitle = "Manual test run for Chromium upgrade on OS X for " + key
...
print(bigline)
print("")
wintitle = "Manual test run for Chromium upgrade on Windows ia-32 for " + key
...
print(bigline)
print("")
wintitle = "Manual test run for Chromium upgrade on Windows x64 for " + key
winlist = ['OS/Windows', 'release-notes/exclude', 'tests']
...
print(bigline)
print("")
lintitle = "Manual test run for Chromium upgrade on Linux for " + key
